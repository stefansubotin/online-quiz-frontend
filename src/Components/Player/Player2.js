            ...
            <div name='home' style={{ display: 'flex' }}>
                ...
                <span>
                    ...
                    <form onSubmit={(e) => this.onTriggerCreate(e)}>
                        <input className="rounded " type="text" name="user" placeholder='Choose Username' required='true' /><br />
                ...
                <span>
                    ...
                    <form onSubmit={this.onTriggerJoin}>
                        <input className="rounded " type="text" name="user" placeholder='Choose Username' /><br />
                        <input className="rounded " type="text" name="room" placeholder='Enter RoomID' /><br /><br />
